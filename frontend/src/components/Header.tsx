...
const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 backdrop-blur-xl border-b transition-all duration-300 ${darkMode
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <nav className="hidden md:flex space-x-2">
            <button
              ...
              className={`group px-6 py-3 rounded-xl font-medium transition-all duration-300 transform hover:scale-105 ${activeTab === 'explore'
            ...
            <button
              ...
              className={`group px-6 py-3 rounded-xl font-medium transition-all duration-300 transform hover:scale-105 ${activeTab === 'agent-application'
            ...
            <button
              ...
              className={`group px-6 py-3 rounded-xl font-medium transition-all duration-300 transform hover:scale-105 relative ${activeTab === 'itineraries'
            ...
            <button
              ...
              className={`group px-6 py-3 rounded-xl font-medium transition-all duration-300 transform hover:scale-105 ${activeTab === 'travel'
          ...
          <div className="flex items-center space-x-3">
            {onShowWallet && (
              <button
                ...
                className={`p-3 rounded-xl transition-all duration-300 transform hover:scale-110 flex items-center space-x-2 ${darkMode
            ...
            <button
              ...
              className={`p-3 rounded-xl transition-all duration-300 transform hover:scale-110 ${darkMode
            ...
            {userDetails && (
              <div className="relative">
                <button
                  ...
                  className={`flex items-center space-x-3 p-3 rounded-xl transition-all duration-300 transform hover:scale-105 ${darkMode
                ...
                {showUserMenu && (
                  <div className={`absolute right-0 mt-3 w-80 rounded-2xl shadow-2xl backdrop-blur-xl border transition-all duration-300 animate-fadeIn ${darkMode
                    ...
                    <div className="p-6 border-b border-gray-200/20 dark:border-gray-700/30">
                      <div className="flex items-center space-x-4">
                        ...
                        <div className="flex-1">
                          ...
                          <span className={`inline-block mt-2 px-3 py-1 rounded-full text-xs font-medium shadow-md ${userDetails.authLevel === 'VERIFIED'
                    ...
                    <div className="p-4 space-y-2">
                      <button
                        ...
                        className={`w-full text-left p-4 rounded-xl transition-all duration-300 transform hover:scale-105 ${darkMode ? 'hover:bg-gray-700/50' : 'hover:bg-gray-100'
                      ...
                      <button
                        ...
                        className={`w-full text-left p-4 rounded-xl transition-all duration-300 transform hover:scale-105 ${darkMode ? 'hover:bg-red-900/30 text-red-400' : 'hover:bg-red-50 text-red-600'
